...
struct MinMaxInfo {
   ...
   static constexpr uint64_t kVariableSize = 1;
...
class Integer {
 public:
   ...
   inline void minmax(MinMaxInfo& m) { m(value); m.max_len = sizeof(int32_t); }
};
//---------------------------------------------------------------------------
...
template <unsigned maxLen> class Varchar {
 ...
 public:
  ...
  inline void minmax(MinMaxInfo& m) { (void)m; m.max_len = maxLen; m.flags |= MinMaxInfo::kVariableSize; }
};
//---------------------------------------------------------------------------
...
template <> class Char<1> {
 ...
 public:
   ...
   inline void minmax(MinMaxInfo& m) { m(value);  m.max_len = 1; }
};
//---------------------------------------------------------------------------
...
template <unsigned len, unsigned precision> class Numeric {
 public:
   ...
   inline void minmax(MinMaxInfo& m) { m(value); m.max_len = sizeof(int64_t); }
...
class Timestamp {
 public:
   ...
   inline void minmax(MinMaxInfo& m) { m(value);  m.max_len = sizeof(uint64_t);}
